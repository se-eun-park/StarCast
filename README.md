...
<div align="center">
<img src="https://i.ibb.co/chYz8mw/Frame-52.png" width='100%' alt="logo"/>

# StarCast - 내 손안의 가장 쉬운 별빛여행
**다양한 천문 현상을 최적의 조건에서 즐길 수 있도록 관측 장소를 분석하는 천체 관측 분석 서비스**  
**프로젝트 기간 :** 2024. 08 ~ 2024. 10 (7주)
</div>
...
* **기상청 단기 예보 API**, **월령 API**, **천문현상 API**를 통합하여 특정 일자가 천체 관측에 적합한 날인지 판단하고, 최적의 관측 장소를 분석해요.

* **기상 조건, 월령, 천문 현상** 등의 데이터를 종합적으로 분석하고, **Hadoop을 이용한 빅데이터 분산 처리 기법**을 통해 방대한 데이터를 효율적으로 처리하여 최적의 관측 조건을 제공해줘요. 
