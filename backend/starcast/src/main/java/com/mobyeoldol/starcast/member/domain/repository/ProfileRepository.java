...
public interface ProfileRepository extends JpaRepository<Profile, String> {
    ...
    @Modifying(clearAutomatically = true)
    @Query("update Profile p set p.profileImgNum = :imageNum where p.profileUid = :profileUid")
    Optional<Profile> updateImageOnProfileById(String profileUid, String imageNum);
}